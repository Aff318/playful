...
var campaignID = "6805467ac8fac91d8bf31d61";
...
var initialSrc = "https://play.playfulrwrds.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("play.playfulrwrds.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://play.playfulrwrds.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://play.playfulrwrds.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
